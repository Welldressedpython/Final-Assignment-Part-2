...
# Plot 4 Develop a Bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
                    ...
                    x='unemployment_rate',
                    y='Automobile_Sales',
                    title='Effect of Unemployment on Sales of Vehicle Types'))
...
# Plot 4 Total Advertisement Expenditure for each vehicle using pie chart
        ...
        exp_data=yearly_data.groupby('Vehicle_Type')['Advertising_Expenditure'].sum().reset.index()
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values=['Advertising_Expenditure'], y='Vehicle_Type',
        title='Advertising Expense per Vehicle Type'))
